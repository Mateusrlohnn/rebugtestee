            ...
            if (params.length > 0) {
                if (params[0].equals("?") || params[0].equals("lista")) {
                    sendAlert("Tipos de nitro disponíveis: \n" +
                            ...
                            "\n\n- 1/fut/nitro/click: " + RoomProcessingType.CLICK.getDescription() +
                            "\n\n- 2/rnd/aleatorio: " + RoomProcessingType.RANDOM.getDescription() +
                            "\n\n- 3/pressao/rebug: " + RoomProcessingType.PRESSURE.getDescription(), client);
                    return;
                }
