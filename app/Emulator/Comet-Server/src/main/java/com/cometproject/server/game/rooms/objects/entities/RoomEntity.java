...
public abstract class RoomEntity extends RoomFloorObject implements AvatarEntity {
    ...
    private int previousBodyRotation;
    ...
    public RoomEntity(int identifier, Position startPosition, int startBodyRotation, int startHeadRotation, Room roomInstance) {
        ...
        this.previousBodyRotation = startBodyRotation;
    ...
    public int getPreviousBodyRotation() {
        return this.previousBodyRotation;
    }

    @Override
    public void setBodyRotation(int rotation) {
        this.previousBodyRotation = this.bodyRotation;
        this.bodyRotation = rotation;
    }

    public boolean hasActiveClickWalk() {
        return this.evtWalk != null && this.evtWalk.isWalking;
    }

    private boolean usesClickProcessing() {
        final RoomProcessingType type = this.getRoom().getData().getRoomProcessType();
        return type == RoomProcessingType.CLICK || type == RoomProcessingType.PRESSURE;
    }
