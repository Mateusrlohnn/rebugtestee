...
import com.cometproject.server.network.messages.incoming.user.UnknowEvent1;
...
//        this.eventExecutor = asyncEventExecution ? Executors.newFixedThreadPool(Integer.parseInt((String) Configuration.currentConfig().getOrDefault("comet.network.alternativePacketHandling.threads", "8"))) : null;
    ...
    public void registerUser() {
        ...
        this.getMessages().put(Events.UnknowEvent1, new UnknowEvent1());
    ...
    public void registerRoom() {
        ...
        this.getMessages().put(Events.NewKissesMessageEvent, new NewKissesMessageEvent());
